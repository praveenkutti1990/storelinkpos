...
class PurchasesModel extends TransactionsModel
{
    ...
    {
        $sql = "INSERT INTO sales (ref, type, channel, data, userid, deviceid, locationid, custid, discount, total, balance, status, processdt, duedt, dt) VALUES (:ref, 'purchase', :channel, :data, :userid, :deviceid, :locationid, :custid, :discount, :total, :balance, :status, :processdt, :duedt, '".date("Y-m-d H:i:s")."')";
        $placeholders = [
            ':ref'        => $ref,
            ':channel'    => $channel,
            ':data'       => $data,
    ...
    {
        $sql = "INSERT INTO sales (id, ref, type, channel, data, userid, deviceid, locationid, custid, discount, total, balance, status, processdt, duedt, dt) VALUES (:id, :ref, 'purchase', :channel, :data, :userid, :deviceid, :locationid, :custid, :discount, :total, :balance, :status, :processdt, :duedt, '".date("Y-m-d H:i:s", $processdt/1000)."')";
        $placeholders = [
            ':id'        => $id,
            ':ref'        => $ref,
            ':channel'    => $channel,
    ...
    public function getOpenInvoices() {
        $sql = "SELECT * FROM sales WHERE balance!=0 AND type='purchase'";
