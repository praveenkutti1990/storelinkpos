...
function routeApiCall($action, $data, $result) {
    ...
    // admin only
        ...
        // PURCHASES
        case "purchases/get":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->getInvoices($result);
            break;

        case "purchases/search":
            $purMdl = new WposPurchases();
            if (isset($data)) {
                $result = $purMdl->searchInvoices($data, $result);
            }
            break;

        case "purchases/add":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->createInvoice($result);
            break;

        case "purchases/edit":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->updateInvoice($result);
            break;

        case "purchases/delete":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->removeInvoice($result);
            break;

        case "purchases/items/add":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->addItem($result);
            break;

        case "purchases/items/edit":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->updateItem($result);
            break;

        case "purchases/items/delete":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->removeItem($result);
            break;

        case "purchases/payments/add":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->addPayment($result);
            break;

        case "purchases/payments/edit":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->updatePayment($result);
            break;

        case "purchases/payments/delete":
            $purMdl = new WposPurchases($data);
            $result = $purMdl->removePayment($result);
            break;

        case "purchases/history/get":
            $purMdl = new WposTransactions($data);
            $result = $purMdl->getTransactionHistory($result);
            break;

        case "purchases/generate":
            $purMdl = new WposTransactions(null, $_REQUEST['id'], false);
            $purMdl->generateInvoice();
            break;

        case "purchases/email":
            $purMdl = new WposTransactions($data);
            $result = $purMdl->emailInvoice($result);
            break;
